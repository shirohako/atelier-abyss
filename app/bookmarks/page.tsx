...
export default function BookmarksPage() {
  return (
    <div className="max-w-3xl px-4 m-auto mt-5">
      <div className="flex-1">
        <div id="reverse-image-search" className="my-5">
          <h2 className="text-2xl font-bold">Reverse Image Search</h2>
          <h3 className="text-sm">以图搜索</h3>
        ...
        <div id="music-database" className="my-5">
          <h2 className="text-2xl font-bold">Music Database</h2>
          <h3 className="text-sm">音乐数据库</h3>
          <ul className="grid lg:grid-cols-2 gap-5 mt-5">
            <LinkCard
              title="VGMdb"
            ...
            />
            <LinkCard
              title="Anison Generation"
              desc="アニメソング データベース"
              icon="tabler:database-smile"
              color="teal"
              link="http://anison.info/"
            />
            <LinkCard
              title="東方編曲録"
              desc="東方アレンジのデータベース"
              ...
              color="yellow"
              link="https://touhou.arrangement-chronicle.com/"
            />
            <LinkCard
              title="VocaDB"
              desc="The collaborative database for Vocaloid"
              icon="ph:images"
              color="cyan"
